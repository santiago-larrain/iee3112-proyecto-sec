...
export default {
  ...
  methods: {
    ...
    async actualizarDocumento(caseId, fileId, tipo) {
      return await casosAPI.updateDocumento(caseId, fileId, tipo)
    },
    ...
    async onDocumentoActualizado(data) {
      ...
      // Recargar caso completo para asegurar sincronización
